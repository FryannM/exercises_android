...
public class MainActivityDateandTimePicker extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        setContentView(R.layout.activity_main_dateand_time_picker);
        ...
        mTimePicker = new TimePickerDialog(MainActivityDateandTimePicker.this, mTimePickerListener,
